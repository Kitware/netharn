from netharn.initializers._nx_ext_v2.balanced_isomorphism import (
    longest_common_balanced_isomorphism,
)
from netharn.initializers._nx_ext_v2.tree_embedding import tree_to_seq, seq_to_tree
...
def maximum_common_ordered_subtree_isomorphism(
    ...
    impl : str
        ...
        See :func:`netharn.initializers._nx_ext_v2.balanced_sequence.longest_common_balanced_sequence`
