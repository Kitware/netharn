...
Notes:
    ...
    cd ~/code/netharn/docs
    sphinx-apidoc -f -o ~/code/netharn/docs/source ~/code/netharn/netharn --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/netharn/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/netharn/versions/
"""
#
...
# html_logo = '.static/netharn.svg'
# html_favicon = '.static/netharn.ico'
...
latex_documents = [
    (master_doc, 'netharn.tex', 'netharn Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'netharn', 'netharn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'netharn', 'netharn Documentation',
     author, 'netharn', 'One line description of project.',
     'Miscellaneous'),
]
